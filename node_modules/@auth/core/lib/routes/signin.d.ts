 ...
 */
export declare function signin(query: RequestInternal["query"], body: RequestInternal["body"], options: InternalOptions<"oauth" | "oidc" | "email">): Promise<ResponseInternal>;
