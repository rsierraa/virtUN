  ...
  return (
    <div className="w-full relative">
      <textarea
        ...
        placeholder=""
        className={`max-h-[150px] min-h-[150px] peer w-full p-4 pt-6 outline-none bg-white font-light border-2 rounded-md transition disabled:opacity-70 disabled:cursor-not-allowed
